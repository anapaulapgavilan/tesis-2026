...
Orden de ejecución:
  ...
  6. Tabla 5 + Figura 3: DiD moderno (stacked)
  7. Tabla 6: MDES / poder estadístico
...
STEPS = [
    ...
    ("Tabla 5 — DiD moderno (stacked)",        "did_moderno.run_stacked_did"),
    ("Tabla 6 — MDES / poder estadístico",     "tesis_alcaldesas.models.mdes_power"),
