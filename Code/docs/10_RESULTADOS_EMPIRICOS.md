...
**Primer canal: la oferta financiera es exógena al poder local.**  La distribución de sucursales bancarias, terminales punto de venta y productos financieros en México responde principalmente a decisiones de la banca comercial y de la Comisión Nacional Bancaria y de Valores, no a la política municipal.  El margen de acción directa de un gobierno municipal sobre la infraestructura financiera es limitado, por lo que es plausible que la representación política femenina no tenga un efecto de primer orden sobre la oferta de servicios financieros.

**Segundo canal: horizonte temporal insuficiente.**  El panel abarca un máximo de 17 trimestres (poco más de cuatro años).  Si los mecanismos causales operan a través de cambios graduales en la confianza institucional, la cultura financiera o el diseño de programas locales de empoderamiento económico, es posible que el horizonte de observación sea demasiado corto para detectar un efecto acumulativo.  El event study confirma la ausencia de efectos dinámicos incluso ocho trimestres después del tratamiento, lo cual es consistente con esta hipótesis.

**Tercer canal: heterogeneidad cancelada.**  Los análisis de heterogeneidad muestran coeficientes de signos opuestos en distintos subgrupos (positivo en metrópolis, negativo en municipios rurales), lo que sugiere la posibilidad de efectos compensados en la estimación promedio.  No obstante, ninguno de estos efectos subgrupales alcanza significancia tras la corrección por pruebas múltiples, por lo que esta interpretación permanece especulativa.
