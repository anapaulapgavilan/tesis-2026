...
Finalmente, conviene subrayar que los hallazgos del Stacked DiD modifican la narrativa: la evidencia sugiere que la representación política femenina municipal **sí tiene un efecto positivo sobre medidas agregadas de inclusión financiera femenina** (contratos totales y saldos), pero que este efecto no se traduce en mayor adopción de productos específicos (tarjetas e hipotecas).  La discrepancia entre estimadores es consistente con sesgos de atenuación del TWFE bajo adopción escalonada, en tanto Stacked DiD restringe la comparación a never-treated dentro de ventanas alrededor del evento.
