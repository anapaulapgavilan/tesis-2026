...
de estatus al menos una vez durante el panel, y dos grandes cohortes de entrada
alineadas con los ciclos electorales municipales (2018Q3–Q4 y 2021Q4–2022Q1).
...
| `ever_alcaldesa` | $\max_t D_{it}$; 1 si el municipio tuvo alcaldesa alguna vez | Balance, heterogeneidad |
...
*\*Nota: Los 394 municipios con primer tratamiento en 2018Q3 incluyen tanto
always-treated puros como municipios que pierden y recuperan el tratamiento. Para el
event study se excluyen los que carecen de periodos pre-tratamiento.*

**Cohortes de entrada (periodo de primer tratamiento):**

| Cohorte | Municipios | Contexto |
|---------|-----------|----------|
| 2018Q3 | 394 | Inicio del panel (ciclo electoral 2018) |
| 2018Q4 | 234 | Tomas de posesión tardías |
...
| `ever_alcaldesa` | Absorbido por el FE de municipio (es time-invariant) |
...
|---|--------|---------------|---------------|
| R1 | **Escala del outcome** | $Y_{pc}$ (nivel), $Y_{pc,w}$ (winsorizada), $Y_{pc,\text{asinh}}$ | Verificar que resultados no dependen de la transformación |
...
- **Potencia estadística:** Con 894 switchers, los subgrupos más pequeños
...
| **Tabla 3** — Robustez | Panel A: escalas (nivel, winsor, asinh). Panel B: excluir transiciones. Panel C: C&S vs TWFE | Signos y magnitudes consistentes con Tabla 2 |
...
├── 00_README.md
├── 01_BRIEF.md
├── 02_EDA_EXPLICACION.md
├── 03_EDA_EXPLICACION_2.md
├── 04_EDA_EXPLICACION_3.md
├── 05_EDA_EXPLICACION_4.md
└── 06_MODELADO_PROPUESTA.md    ← este documento
```
