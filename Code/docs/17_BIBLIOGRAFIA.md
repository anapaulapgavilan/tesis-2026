# Bibliografía clave (DiD moderno) y dónde se referencian
...
| Stacked DiD (implementación concreta de apilar cohortes/event windows) | Cengiz, Dube, Lindner & Zipperer (2019) | **Doc 10 §4.5** (definición del estimador/algoritmo stacked), **Doc 09** (robustez moderna), **Doc 11** (especificación formal: cohorte vs never-treated, ventana [-4,+8], clustering por cve_mun) |
