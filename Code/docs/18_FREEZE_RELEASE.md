# 18 — Freeze & Release: Instrucciones para congelar resultados
...
| `docs/09_MODELADO_ECONOMETRICO.md` | Especificación formal del diseño |
| `docs/10_RESULTADOS_EMPIRICOS.md` | Narrativa de resultados |
| `docs/11_DID_MODERNO.md` | Documentación del Stacked DiD |
| `src/did_moderno/run_stacked_did.py` | Estimador principal |
