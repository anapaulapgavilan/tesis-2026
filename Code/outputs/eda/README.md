...
| **D** | Relaciones bivariadas alineadas a la pregunta | `D1_*.png` – `D7_*.png` |
...
| `C2_tipo_exposicion.png` | IMG | Switchers vs nunca/siempre tratados |
| `C3_distribucion_poblacion.png` | IMG | Histogramas de población (log) |
| `C4_boxplot_outcomes_mujeres_pc.png` | IMG | Distribución de outcomes per cápita |
| `C5_categoricas_clave.png` | IMG | Distribución de región, tipo_pob, estados |
...
| `D3_tendencias_paralelas.png` | IMG | **Clave**: ¿tendencias paralelas pre-tratamiento? |
...
| `D7_heatmap_alcaldesa_estado_year.png` | IMG | Mapa de calor: alcaldesas por estado/año |
